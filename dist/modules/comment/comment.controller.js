...
let CommentController = class CommentController {
    ...
    getCommentByLearningPath(id_ruta) {
...
__decorate([
    (0, common_1.Get)('/comment/:id_ruta'),
    __param(0, (0, common_1.Param)('id_ruta', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], CommentController.prototype, "getCommentByLearningPath", null);
__decorate([
    (0, common_1.Post)('/crear-comentario'),
...
__decorate([
    (0, common_1.Patch)('/actualizar-comentario/:id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    (0, common_1.Delete)('/eliminar-comment/:id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
