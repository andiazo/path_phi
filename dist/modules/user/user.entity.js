...
__decorate([
    (0, typeorm_1.ManyToMany)(type => learning_path_entity_1.LearningPath, learningPath => learningPath.users, { eager: true }),
    ...
    __metadata("design:type", Array)
], User.prototype, "learningPaths", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(Type => comment_entity_1.Comment, comment => comment.user, { eager: true }),
    (0, typeorm_1.JoinTable)({
