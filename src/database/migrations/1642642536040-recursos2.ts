...
export class recursos21642642536040 implements MigrationInterface {
    name = 'recursos21642642536040'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tema-ruta" ("id_tema" integer NOT NULL, "rutaIdRuta" integer NOT NULL, CONSTRAINT "PK_e2170328790c8431129baa5253d" PRIMARY KEY ("id_tema", "rutaIdRuta"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6c4e148a15a27470ec663e3c8b" ON "tema-ruta" ("id_tema") `);
        await queryRunner.query(`CREATE INDEX "IDX_b6534c6dc6515b7c00e9a18035" ON "tema-ruta" ("rutaIdRuta") `);
        ...
        await queryRunner.query(`ALTER TABLE "tema-ruta" ADD CONSTRAINT "FK_b6534c6dc6515b7c00e9a18035d" FOREIGN KEY ("rutaIdRuta") REFERENCES "ruta"("id_ruta") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tema-ruta" DROP CONSTRAINT "FK_b6534c6dc6515b7c00e9a18035d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b6534c6dc6515b7c00e9a18035"`);
