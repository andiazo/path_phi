...
export class actualizacion21643754013239 implements MigrationInterface {
    name = 'actualizacion21643754013239'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ruta" ("id_ruta" SERIAL NOT NULL, "nombre_ruta" character varying(40) NOT NULL, "descripcion_ruta" character varying(150) NOT NULL, "dificultad" integer NOT NULL, "cantidad_temas" integer NOT NULL, "cantidad_recursos" integer NOT NULL, "status" character varying(8) NOT NULL DEFAULT 'ACTIVE', "commentIdComment" integer, CONSTRAINT "UQ_1148dea49b9169bfb24d21502e9" UNIQUE ("nombre_ruta"), CONSTRAINT "UQ_8cb1c5f3085ae72b6222b15ecb7" UNIQUE ("descripcion_ruta"), CONSTRAINT "PK_26a5677b445ca25ad52aa2d8af5" PRIMARY KEY ("id_ruta"))`);
        await queryRunner.query(`CREATE TABLE "comentario" ("id_comment" SERIAL NOT NULL, "content" character varying(150) NOT NULL, "status" character varying(8) NOT NULL DEFAULT 'ACTIVE', "userId" integer, CONSTRAINT "PK_a7431b4b074e1daba64e2f5b3c4" PRIMARY KEY ("id_comment"))`);
